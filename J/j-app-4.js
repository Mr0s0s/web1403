...
// app.use('POST', '/login_constant', function (request, response) {
...
//         return -1;
//     }
//     fs.readFile('./user.json', function (error, fileData) {
//         if (error) {
//             console.log('request.method:', request.method, '| request.url:', request.url, '| Cant read File for:', error.code);
...
//                 console.log('user:', request.data.user, '| password:', request.data.pass);
//                 app.write(response, "Login Done." + ' | user:' + request.data.user + " | password:" + request.data.pass, 'txt', 'Value = 12345678');
//             }
//         }
//     });
// });
